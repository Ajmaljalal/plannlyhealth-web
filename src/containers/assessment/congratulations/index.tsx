...
function CongratulationsContainer() {
  ...
  return (
    <div className='flex flex-col items-center h-full p-[10px] pt-[32px] md:pt-[152px] bg-basic_white'>
      ...
      {/* <p className='text-center'>View all your rewards on the rewards page.</p> */}
      <div className='w-fit py-[32px] px-[40px] flex flex-col gap-4 md:flex-row w-full justify-center'>
        {/* <Button text='Recommendations' className='w-full md:w-[160px]' isPrimary onClick={() => router.push('/employee/rewards')} /> */}
        <Button text='View my rewards' isPrimary className='w-full md:w-[160px]' onClick={() => router.push('/employee/rewards')} />
      </div>
