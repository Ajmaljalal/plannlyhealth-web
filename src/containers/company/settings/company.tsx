  ...
  return (
    <form className='max-w-[692px] mt-[56px] flex gap-12 flex-wrap' onChange={handleChange} onSubmit={handleSave}>
      <div className='flex w-full gap-4 flex-wrap'>
        ...
        <CheckBox label="Limit sign-up to only the employees with the company domain" name="onlyCompanyDomain" value={companyState.onlyCompanyDomain} checked={companyState.onlyCompanyDomain} onChange={handleCheckBoxChange} />
      </div>
